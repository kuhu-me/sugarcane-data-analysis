...
To understand the spread, variability, and outliers in the data:
- Violin plot for **Yield (Kg / Hectare)**
- Violin plot for **Acreage (Hectare)**
- Violin plot for **Production per Person (Kg)**
- Violin plot for **Total Production (Tons)**

---

### 2️⃣ Comparative Analysis
To compare sugarcane performance across regions and countries:
- Bar chart showing **Distribution of Countries Across Continents**
- Bar chart for **Average Sugarcane Yield by Continent**
- Bar chart of **Top 10 Sugarcane Producing Countries**

---

### 3️⃣ Relationship & Correlation Analysis
To study relationships between important numerical variables:
- Scatter plot of **Production vs Acreage** (continent-wise comparison)
- Scatter plot of **Yield vs Production per Person**
- **Correlation Heatmap** for numerical features such as yield, production, acreage, and production per person
